...
public class Beverage {
    ...
    private BeverageStyle beerStyle;
    private String upc;
    ...
    Beverage(UUID id, Integer version, String beerName, BeverageStyle beerStyle, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
    ...
    public static BeverageBuilder builder() {
    ...
    public BeverageStyle getBeerStyle() {
    ...
    public void setBeerStyle(BeverageStyle beerStyle) {
        this.beerStyle = beerStyle;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final Beverage other = (Beverage) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof Beverage;
    }
    ...
    public String toString() {
        return "Beverage(id=" + this.getId() + ", version=" + this.getVersion() + ", beerName=" + this.getBeerName() + ", beerStyle=" + this.getBeerStyle() + ", upc=" + this.getUpc() + ", quantityOnHand=" + this.getQuantityOnHand() + ", price=" + this.getPrice() + ", createdDate=" + this.getCreatedDate() + ", updateDate=" + this.getUpdateDate() + ")";
    }
    ...
    public static class BeverageBuilder {
        ...
        public BeverageBuilder id(UUID id) {
            this.id = id;
            return this;
        }

        public BeverageBuilder version(Integer version) {
            this.version = version;
            return this;
        }

        public BeverageBuilder beerName(String beerName) {
            this.beerName = beerName;
            return this;
        }

        public BeverageBuilder beerStyle(BeverageStyle beerStyle) {
            this.beerStyle = beerStyle;
            return this;
        }

        public BeverageBuilder upc(String upc) {
            this.upc = upc;
            return this;
        }

        public BeverageBuilder quantityOnHand(Integer quantityOnHand) {
            this.quantityOnHand = quantityOnHand;
            return this;
        }

        public BeverageBuilder price(BigDecimal price) {
            this.price = price;
            return this;
        }

        public BeverageBuilder createdDate(LocalDateTime createdDate) {
            this.createdDate = createdDate;
            return this;
        }

        public BeverageBuilder updateDate(LocalDateTime updateDate) {
            this.updateDate = updateDate;
            return this;
        }

        public Beverage build() {
            return new Beverage(this.id, this.version, this.beerName, this.beerStyle, this.upc, this.quantityOnHand, this.price, this.createdDate, this.updateDate);
        }

        public String toString() {
            return "Beverage.BeverageBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyle + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}
